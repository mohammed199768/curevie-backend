...
FROM (
  VALUES
    ('CBC (Complete Blood Count)', 'صورة دم كاملة', 'Complete blood count panel for hematology screening.', 'باقة صورة دم كاملة لتقييم مكونات الدم الأساسية.', 15.00, 'edta', 8),
    ('Lipid Profile', 'دهون الدم', 'Comprehensive lipid profile for cardiovascular risk screening.', 'باقة دهون الدم لتقييم مخاطر القلب والشرايين.', 18.00, 'serum', 10),
    ('Liver Function Tests (LFT)', 'وظائف الكبد', 'Core liver enzymes and protein markers.', 'باقة وظائف الكبد لقياس الإنزيمات والبروتينات المرتبطة بالكبد.', 20.00, 'serum', 10),
    ('Kidney Function Tests (KFT)', 'وظائف الكلى', 'Renal function and electrolyte markers.', 'باقة وظائف الكلى ومؤشرات الأملاح المرتبطة بها.', 18.00, 'serum', 10),
    ('Thyroid Profile (TFT)', 'وظائف الغدة الدرقية', 'Thyroid hormone screening panel.', 'باقة تقييم هرمونات الغدة الدرقية.', 25.00, 'serum', 12),
    ('Diabetes Panel (HbA1c + FBS)', 'باقة السكري', 'Glucose control and insulin resistance markers.', 'باقة تقييم التحكم بالسكري ومقاومة الإنسولين.', 20.00, 'serum,edta', 10),
    ('Iron Studies', 'دراسة الحديد', 'Iron stores and transport assessment.', 'باقة تقييم مخزون الحديد ونقله في الجسم.', 22.00, 'serum', 12),
    ('Cardiac Markers', 'مؤشرات القلب', 'Laboratory cardiac injury and thrombosis markers.', 'باقة مؤشرات القلب والجلطات المخبرية.', 35.00, 'serum,plasma', 6),
    ('Inflammatory Markers', 'مؤشرات الالتهاب', 'Inflammation and infection activity markers.', 'باقة مؤشرات الالتهاب والعدوى.', 18.00, 'serum,edta,citrate', 8),
    ('Hormone Panel (Female)', 'باقة الهرمونات للنساء', 'Female reproductive hormone profile.', 'باقة الهرمونات الأنثوية وتقييم الخصوبة.', 30.00, 'serum', 12)
...
FROM (
  VALUES
    ('Basic Health Check', 'الفحص الصحي الأساسي', 'Balanced starter package for routine screening.', 'حزمة أساسية للفحص الدوري العام.', 45.00),
    ('Comprehensive Metabolic Panel', 'الحزمة الأيضية الشاملة', 'Extended metabolic and endocrine screening package.', 'حزمة موسعة لفحص المؤشرات الأيضية والهرمونية.', 75.00),
    ('Cardiac Risk Assessment', 'تقييم مخاطر القلب', 'Focused package for cardiovascular risk evaluation.', 'حزمة مركزة لتقييم مخاطر القلب والشرايين.', 60.00),
    ('Women''s Health Package', 'حزمة صحة المرأة', 'Comprehensive women''s health laboratory package.', 'حزمة مخبرية شاملة لصحة المرأة.', 85.00)
...
FROM (
  VALUES
    ('Home Doctor Visit', 'زيارة طبيب منزلية تشمل التقييم السريري ووضع خطة علاج أولية.', 35.00, 'General Medicine'),
    ('Comprehensive Home Care', 'رعاية منزلية شاملة تشمل طبيبًا وخدمة أشعة منزلية مع فحوصات أساسية.', 120.00, 'Home Care'),
    ('Elderly Care Package', 'حزمة رعاية منزلية لكبار السن تشمل زيارة طبية وتمريضية مع متابعة وظائف الكلى.', 95.00, 'Home Care')
